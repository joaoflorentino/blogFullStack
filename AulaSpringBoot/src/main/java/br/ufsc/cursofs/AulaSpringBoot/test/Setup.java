...
public class Setup implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Endereco e1 = new Endereco(null, "casa", "Rua das Palmeiras", "333", "89.001-001");
		Endereco e2 = new Endereco(null, "trabalho", "Rua dos Coqueiros", "222", "89.222-001");
		Endereco e3 = new Endereco(null, "casa", "Rua das Rosas", "111", "91.002-004");
		Endereco e4 = new Endereco(null, "sitio", "Rua dos Cravos", "34", "89.003-007");
		Endereco e5 = new Endereco(null, "trabalho", "Rua das Laranjeiras", "1234", "90.001-001");
		Endereco e6 = new Endereco(null, "trabalho", "Rua das Laranjeiras", "1234", "90.001-001");
